...
void menu(){
    ...
    if(opcao==1){
        ...
        cout << "A BATTLE FASE, O PROPRIO COMPUTADOR, QUE POR SUA VEZ FAZ O MESMO PROCESSO ESCOLHENDO A CARTA PARA RECEBER O ATAQUE. " << endl;
        cout << "DANDO INICIO A BATTLE FASE, CADA CARTA TEM UM [TIPO] ASSOCIADO QUE INTERFERE DIRETAMENTE NO ATAQUE, UMA VEZ QUE" << endl;
